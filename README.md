...
Lots of todos to be done but it can still be used. Documentation is ongoing. Originally planned to be named _react-cheatsheets_ but "cheat" was forbidden in the registry, so we now have `react-csheets`!
